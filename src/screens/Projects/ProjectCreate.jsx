...
const ProjectCreate = () => {
  ...
  return (
    <MainContainer>
        ...
        <div className='container m-0 p-0'>
          <form onSubmit={handleSubmit(onSubmit)} encType='multipart/form-data'>
            <div className='row g-3'>
              ...
              <div className='col-12'>
                <div className='p-3 bg-light rounded fw-bold border border-1 shadow-sm '>
                  <button type='submit' className='btn btn-color-primary py-3 px-5' data-bs-toggle='modal' data-bs-target={`#m-${'63cfc3230579dc98c993d590'}`}>
                    Crear proyecto
                  </button>
                </div>
              </div>
      ...
      <Modal modalId={'63cfc3230579dc98c993d590'} />
    </MainContainer>
  );
};
